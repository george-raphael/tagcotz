<template>
    <div class="mt-3 grid grid-cols-3 sm:grid-cols-6 md:grid-cols-9 lg:grid-cols-12 gap-3">
        <div class="col-span-3 bg-white shadow-sm rounded-lg p-3 border-l-8 border-blue-500">
            <div class="">
                <h1 class="">All</h1>
            </div>
